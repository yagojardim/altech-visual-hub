      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div className="min-w-0 space-y-1">
          <div className="flex items-center gap-2">
            <h1 className="text-xl font-semibold tracking-tight sm:text-2xl">Visão Geral do Projeto</h1>
            <span className="inline-flex rounded-full border border-accent/30 bg-accent/15 px-2 py-0.5 text-[11px] text-accent">
              Projeto
            </span>
          </div>
          <p className="text-sm text-muted-foreground">
            Visão consolidada do projeto com resumo, indicadores e próximas entregas.
          </p>
        </div>
